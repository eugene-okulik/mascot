...
class EcoFriendlySorting(BasePage):
    ...
    def sort_items_by_name_descending(self):
        sorter = self.page.locator('#sorter').first.select_option('Product Name')
    ...
    def sort_items_by_price(self):
        sorter = self.page.locator('#sorter').first.select_option('Price')
    ...
    def check_initial_toolbar_text(self):
        ...
        actual_text = toolbar_text_locator.text_content()
        expect(toolbar_text_locator).to_have_text("Items 1-12 of 18")

    def switch_to_list_view(self):
        list_view_button = self.page.locator('#mode-list').nth(0).click()
